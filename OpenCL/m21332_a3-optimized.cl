...
DECLSPEC void m21332m (u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  salt_buf0_t[0] = 0xA6648D51;
  salt_buf0_t[1] = 0xC1D8DE35;
  salt_buf0_t[2] = 0xB139B0E6;
  salt_buf0_t[3] = 0x3052E5C3;
  salt_buf1_t[0] = 0;
  salt_buf1_t[1] = 0;
  salt_buf1_t[2] = 0;
  salt_buf1_t[3] = 0;
  ...
  const u32 salt_pw_salt_len = salt_len + pw_len + 16;
  ...
  for (u32 il_pos = 0; il_pos < il_cnt; il_pos += VECT_SIZE)
  {
    ...
    COMPARE_M_SIMD_PS4 (a, b);
  }
}

DECLSPEC void m21332s (u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < il_cnt; il_pos += VECT_SIZE)
  {
    ...
    COMPARE_S_SIMD_PS4 (a, b);
  }
}

KERNEL_FQ void m21332_m04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21332_m08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21332_m16 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21332_s04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21332_s08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21332_s16 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */

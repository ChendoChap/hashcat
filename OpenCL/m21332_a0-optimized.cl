...
KERNEL_FQ void m21332_m04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < il_cnt; il_pos += VECT_SIZE)
  {
    ...
    const u32x salt_out_salt_len = salt_len + out_len + 16;
...
KERNEL_FQ void m21332_m08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m21332_m16 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m21332_s04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m21332_s08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m21332_s16 (KERN_ATTR_RULES ())
{
}

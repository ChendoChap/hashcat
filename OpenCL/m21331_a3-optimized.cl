...
DECLSPEC void m21331m (u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  salt_buf0_t[0] = 0x99655967;
  salt_buf0_t[1] = 0x90042504;
  salt_buf0_t[2] = 0x49276456;
  salt_buf0_t[3] = 0x1A748994;
  salt_buf1_t[0] = 0;
  salt_buf1_t[1] = 0;
  salt_buf1_t[2] = 0;
  salt_buf1_t[3] = 0;
  ...
  for (u32 il_pos = 0; il_pos < il_cnt; il_pos += VECT_SIZE)
  {
    ...
    COMPARE_M_SIMD_PS3 (a);
  }
}

DECLSPEC void m21331s (u32 *w0, u32 *w1, u32 *w2, u32 *w3, const u32 pw_len, KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < il_cnt; il_pos += VECT_SIZE)
  {
    ...
    COMPARE_S_SIMD_PS3 (a);
  }
}

KERNEL_FQ void m21331_m04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21331_m08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21331_m16 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21331_s04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21331_s08 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m21331_s16 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
